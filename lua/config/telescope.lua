...
keybinds.map("n", "<space>fb", builtin.buffers, "Search Buffers")
keybinds.map("n", "<space>ff", builtin.find_files, "Search Files")
keybinds.map("n", "<space>fg", builtin.live_grep, "Live Grep")
keybinds.map("n", "<space>fr", builtin.oldfiles, "Recent Files")
keybinds.map("n", "<space>fh", builtin.help_tags, "Search Help")
keybinds.map("n", "<space>fs", builtin.grep_string, "Search Grep String")
...
keybinds.map("n", "<space>fd", function()
	builtin.find_files({ cwd = vim.fn.stdpath("data") })
end, "Search Neovim Data")

keybinds.map("n", "<space>fa", function()
